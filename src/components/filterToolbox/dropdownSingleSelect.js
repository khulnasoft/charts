...
import { Menu, Text, TextMicro, Flex, getColor, getRgbColor } from "@khulnasoft/khulnasoft-ui"
import checkmark_s from "@khulnasoft/khulnasoft-ui/dist/components/icon/assets/checkmark_s.svg"
import information from "@khulnasoft/khulnasoft-ui/dist/components/icon/assets/information.svg"
...
const getBackground = ({ theme }) => {
  ...
  const background =
    name === "Dark" ? getRgbColor(["green", "khulnasoft"], 0.3) : getRgbColor(["green", "frostee"])
